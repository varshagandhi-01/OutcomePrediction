...
from outcome_prediction.constants import TARGET_COLUMN, CURRENT_YEAR
from outcome_prediction.entity.config_entity import ModelEvaluationConfig
from outcome_prediction.entity.artifact_entity import ModelEvaluationArtifact, DataIngestionArtifact, ModelTrainerArtifact
from outcome_prediction.entity.estimator import PrepareModel
from outcome_prediction.entity.estimator import TargetValueMapping
...
class ModelEvaluation:
    def __init__(self, model_eval_config: ModelEvaluationConfig, data_ingestion_artifact: DataIngestionArtifact,
        ...
        try:
            self.mode_eval_config = model_eval_config
    ...
    def get_best_model(self) -> Optional[ModelEstimator]:
        ...
        """
        try:
            bucket_name = self.mode_eval_config.bucket_name
            model_path = self.mode_eval_config.s3_model_key_path
            model_estimator = ModelEstimator(bucket_name=bucket_name, model_path=model_path)
