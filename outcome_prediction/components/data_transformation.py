...
from outcome_prediction.constants import TARGET_COLUMN, SCHEMA_FILE_PATH, CURRENT_YEAR
from outcome_prediction.entity.config_entity import DataTransformationConfig
from outcome_prediction.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact, DataTransformationArtifact
from outcome_prediction.exception.exception_handler import AppException
from outcome_prediction.logger.log import logging
from outcome_prediction.utils.main_utils import save_numpy_array_data, save_object, read_yaml_file, drop_columns
...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        try:
            ...
            # get the columns from schema.yaml
            ...
            preprocessor = ColumnTransformer(
                 [
                      ...
                      ("Ordinal_Encoder", or_encoder, or_columns),
