...
from outcome_prediction.entity.config_entity import ModelTrainerConfig
from outcome_prediction.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
from outcome_prediction.exception.exception_handler import AppException
from outcome_prediction.logger.log import logging
from outcome_prediction.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        """
        try:
            # Using neuro_mf to get best model object and report
            ...
            metric_artifact = ClassificationMetricArtifact(f1_score=f1, precision_score=precision, recall_score=recall_score)
